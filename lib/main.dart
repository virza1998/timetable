...
class _TodoAppState extends State<TodoApp> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> receptionTasks = [
      ...
      "контроль нагрузки: ВЛ 500/220/110; 1-4АТ, 5-6АТГ; 500/220/110/10/0,4кВ",
      "исправность 3U0 на ТН; замер небаланса ДЗШ, ДЗО, КИВ",
      "ЩСН/ЩПТ: нагрузка ТСН, U на шинах, изоляция АБ и блокировки",
      "АБ: отсутствие трещин, течей, уровень электролита, отопление",
      "Связь, АСУТП, АРМ: осмотр панелей, климат, каналы связи",
      "Проверка СЗ, инвентаря, документации, схем АРМ и макета ПС"
    ];
