...
class _TodoAppState extends State<TodoApp> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> receptionTasks = [
      ...
      "контроль напряжения 500/220/110/10/0,4кВ",
      "исправность 3U0 на ТН-500/220/110; замер небаланса ДЗШ-220/110, ДЗО-500 5/6АТГ, КИВ-500 5/6АТГ",
      "осмотр АУПС на отсутствие неисправности, сработавших табло на пультах АУПС",
      "ЩСН: уровни напряжения, нагрузка 1/2/4/5/6ТСН",
      "ЩПТ: проверка U на шинах всех источников опертока 1/2АБ, 1/2/3/4ВУ по имеющимся приборам",
      "ЩПТ: режим работы подзарядных устройств АБ",
      "ЩПТ: по приборам замерить сопротивление изоляции",
      "ЩПТ: по приборам замерить I подзаряда 1/2АБ",
      "замер сопротивления изоляции в цепях оперативной блокировки",
      "АБ: отсутствие трещин и течей на банках 1/2АБ и уровень электролита в них",
      "АБ: температура, освещение в помещении 1/2АБ",
      "АБ: напряжение на вводах 1/2АБ",
      "АБ: проверка отопления в помещении 1/2АБ (в период ОЗП)",
      "панели связи, АСУ ТП, АРМ и ТМ: осмотр, проверка освещения, отопления, вентиляции узла связи; проверка каналов связи",
      "Проверка наличия и состояния СЗ (состояние защитных средств в течении смены)",
      "проверка инвентаря и приспособлений, ключей от ЭУ, средства связи", 
      "проверка видеорегистраторы, диктофон, аптечки, бинокля, фонарей",
      "проверить и принять оперативную документацию",
      "проверка схем: АРМ, схема-макет ПС", 
      "проверка водоснабжения и пожаротушения в соответствии с ведомостью отклонения"
